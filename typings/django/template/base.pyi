...
class Template:
    ...
    source: str = ...
    nodelist: NodeList = ...
    def __init__(self, template_string: Template | str, origin: Origin | None = ..., name: str | None = ..., engine: Engine | None = ...) -> None: ...
    def __iter__(self) -> None: ...
    def render(self, context: Context, request: HttpRequest | None = ...) -> SafeText: ...
...
class Token:
    ...
    def __init__(self, token_type: TokenType, contents: str, position: tuple[int, int] | None = ..., lineno: int | None = ...) -> None: ...
...
class Parser:
    ...
    def invalid_block_tag(self, token: Token, command: str, parse_until: list[Any] | tuple[str] = ...) -> Any: ...
