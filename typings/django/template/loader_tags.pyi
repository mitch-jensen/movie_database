...
class ExtendsNode(Node):
    ...
    def __init__(self, nodelist: NodeList, parent_name: FilterExpression | Node, template_dirs: list[Any] | None = ...) -> None: ...
...
class IncludeNode(Node):
    ...
    def __init__(self, template: FilterExpression, *args: Any, extra_context: Any | None = ..., isolated_context: bool = ..., **kwargs: Any) -> None: ...
    def render(self, context: Context) -> SafeText: ...
