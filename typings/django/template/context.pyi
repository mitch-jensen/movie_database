...
This type stub file was generated by pyright.
"""
type _ContextValues = dict[str, Any] | Context
...
class BaseContext(Iterable[Any]):
    ...
    def setdefault(self, key: IfChangedNode | str, default: list[Origin] | int | None = ...) -> list[Origin] | int | None: ...
    def new(self, values: _ContextValues | None = ...) -> Context: ...
    def flatten(self) -> dict[str, dict[str, type[Any] | str] | int | str | None]: ...
...
class Context(BaseContext):
    ...
    def __init__(self, dict_: Any = ..., autoescape: bool = ..., use_l10n: bool | None = ..., use_tz: None = ...) -> None: ...
