...
class CycleNode(Node):
    ...
    silent: bool = ...
    def __init__(self, cyclevars: list[FilterExpression], variable_name: str | None = ..., silent: bool = ...) -> None: ...
...
class URLNode(Node):
    ...
    asvar: str | None = ...
    def __init__(self, view_name: FilterExpression, args: list[FilterExpression], kwargs: dict[str, FilterExpression], asvar: str | None) -> None: ...
...
class WidthRatioNode(Node):
    ...
    asvar: str | None = ...
    def __init__(self, val_expr: FilterExpression, max_expr: FilterExpression, max_width: FilterExpression, asvar: str | None = ...) -> None: ...

class WithNode(Node):
    nodelist: NodeList = ...
    extra_context: dict[str, Any] = ...
    def __init__(self, var: str | None, name: str | None, nodelist: NodeList | Sequence[Node], extra_context: dict[str, Any] | None = ...) -> None: ...
