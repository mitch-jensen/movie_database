...
from typing import Any, BinaryIO, Self, TypeVar, overload
...
type UploadHandlerList = list[uploadhandler.FileUploadHandler] | ImmutableList[uploadhandler.FileUploadHandler]
T = TypeVar("T")
...
class HttpRequest:
    ...
    def get_signed_cookie(self, key: str, default: T = ..., salt: str = ..., max_age: int | None = ...) -> str | T: ...
...
class QueryDict(MultiValueDict[str, str]):
    encoding: str = ...
    _mutable: bool = ...
    def __init__(self, query_string: str | bytes | None = ..., mutable: bool = ..., encoding: str | None = ...) -> None: ...
    ...
    @classmethod
    def fromkeys(cls, iterable: Iterable[bytes | str], value: Any = ..., mutable: bool = ..., encoding: str | None = ...) -> Self: ...
