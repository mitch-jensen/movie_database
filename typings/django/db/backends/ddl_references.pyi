...
class Columns(TableColumns):
    ...
    def __init__(self, table: str, columns: list[str], quote_name: Callable[..., Any], col_suffixes: list[str] | tuple[Any, ...] = ...) -> None: ...
...
class IndexName(TableColumns):
    ...
    def __init__(self, table: str, columns: list[str], suffix: str, create_index_name: Callable[..., Any]) -> None: ...

class IndexColumns(Columns):
    opclasses: Any = ...
    def __init__(self, table: Any, columns: Any, quote_name: Any, col_suffixes: Any = ..., opclasses: Any = ...) -> None: ...
