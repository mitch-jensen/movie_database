...
class BaseDatabaseSchemaEditor(AbstractContextManager[Any]):
    ...
    def execute(self, sql: Statement | str, params: list[int] | tuple[Any, ...] | None = ...) -> None: ...
    def quote_name(self, name: str) -> str: ...
    def column_sql(self, model: type[Model], field: Field[Any, Any], include_default: bool = ...) -> tuple[str | None, list[Any] | None]: ...
    ...
    def alter_field(self, model: type[Model], old_field: Field[Any, Any], new_field: Field[Any, Any], strict: bool = ...) -> None: ...
