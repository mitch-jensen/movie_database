...
"""
logger: Any
type _Mixed = None | bool | int | float | Decimal | str | bytes | datetime | UUID
type _SQLType = _Mixed | Sequence[_Mixed] | Mapping[str, _Mixed]
...
class CursorWrapper:
    ...
    def callproc(self, procname: str, params: Sequence[_SQLType] | None = ..., kparams: Mapping[str, int] | None = ...) -> None: ...
    def execute(self, sql: str, params: Sequence[_SQLType] | Mapping[str, _SQLType] | None = ...) -> None: ...
    def executemany(self, sql: str, param_list: Sequence[Sequence[_SQLType] | Mapping[str, _SQLType] | None]) -> None: ...
    @property
    ...
    withhold: bool
    def mogrify(self, operation: str, parameters: Sequence[_SQLType] | Mapping[str, _SQLType] | None = ...) -> bytes: ...
    ...
    def copy_from(self, file: IO[str], table: str, sep: str = ..., null: str = ..., size: int = ..., columns: Iterable[str] | None = ...) -> None: ...
    def copy_to(self, file: IO[str], table: str, sep: str = ..., null: str = ..., columns: str | None = ...) -> None: ...
