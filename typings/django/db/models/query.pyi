...
class _BaseQuerySet(Generic[_T], Sized):
    ...
    async def aget_or_create(self, defaults: MutableMapping[str, Any] | None = ..., **kwargs: Any) -> tuple[_T, bool]: ...
    def update_or_create(self, defaults: MutableMapping[str, Any] | None = ..., **kwargs: Any) -> tuple[_T, bool]: ...
    async def aupdate_or_create(self, defaults: MutableMapping[str, Any] | None = ..., **kwargs: Any) -> tuple[_T, bool]: ...
    ...
    def raw(self, raw_query: str, params: Any = ..., translations: dict[str, str] | None = ..., using: str | None = ...) -> RawQuerySet[Any]: ...
    def values(self, *fields: str | Combinable, **expressions: Any) -> ValuesQuerySet[_T, dict[str, Any]]: ...
    def values_list(self, *fields: str | Combinable, flat: bool = ..., named: bool = ...) -> ValuesQuerySet[_T, Any]: ...
    def dates(self, field_name: str, kind: str, order: str = ...) -> ValuesQuerySet[_T, datetime.date]: ...
    def datetimes(self, field_name: str, kind: str, order: str = ..., tzinfo: datetime.tzinfo | None = ...) -> ValuesQuerySet[_T, datetime.datetime]: ...
    def none(self) -> Self: ...
    def all(self) -> Self: ...
    ...
    def select_for_update(self, nowait: bool = ..., skip_locked: bool = ..., of: Sequence[str] = ..., no_key: bool = ...) -> Self: ...
...
class BaseIterable(Sequence[_Row]):
    def __init__(self, queryset: _BaseQuerySet[Any], chunked_fetch: bool = ..., chunk_size: int = ...) -> None: ...
...
class ValuesQuerySet(_BaseQuerySet[_T], Collection[_Row], Sized):
    ...
    async def aiterator(self, chunk_size: int = ...) -> Iterator[_Row]: ...
...
class Prefetch(Generic[_T]):
    ...
    def __init__(self, lookup: str, queryset: QuerySet[Any] | None = ..., to_attr: str | None = ...) -> None: ...
    def __getstate__(self) -> dict[str, Any]: ...
...
def prefetch_related_objects(model_instances: Iterable[models.Model], *related_lookups: str | Prefetch[Any]) -> None: ...
