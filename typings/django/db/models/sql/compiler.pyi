...
class SQLCompiler:
    ...
    klass_info: Any = ...
    ordering_parts: Any = ...
    def __init__(self, query: Query | RawQuery, connection: Any, using: str | None) -> None: ...
    ...
    def collapse_group_by(self, expressions: list[Expression], having: list[Expression] | tuple[Any, ...]) -> list[Expression]: ...
    def get_select(self) -> tuple[list[tuple[Expression, tuple[str, list[int | str]], str | None]], dict[str, Any] | None, dict[str, int]]: ...
    ...
    def compile(self, node: Any, select_format: Any = ...) -> tuple[str, list[int | None] | tuple[int, int]]: ...
    ...
    def get_default_columns(self, start_alias: str | None = ..., opts: Any | None = ..., from_parent: type[Model] | None = ...) -> list[Expression]: ...
    ...
    def get_converters(self, expressions: list[Expression]) -> dict[int, tuple[list[Callable[..., Any]], Expression]]: ...
    def apply_converters(
        self,
        rows: chain[Any],
        converters: dict[int, tuple[list[Callable[..., Any]], Expression]],
    ) -> Iterator[list[bytes | datetime | int | str | None] | list[date | Decimal | float | str | None] | list[datetime | float | str | UUID | None]]: ...
    def results_iter(
        self,
    ...
    def execute_sql(self, result_type: str = ..., chunked_fetch: bool = ..., chunk_size: int = ...) -> Any | None: ...
    def as_subquery_condition(self, alias: str, columns: list[str], compiler: SQLCompiler) -> tuple[str, tuple[Any, ...]]: ...
...
def cursor_iter(cursor: Any, sentinel: Any, col_count: int | None, itersize: int) -> Iterator[Any]: ...
