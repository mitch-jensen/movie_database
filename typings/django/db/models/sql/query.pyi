...
class Query:
    ...
    low_mark: int = ...
    where: WhereNode
    def __init__(self, model: type[Model] | None, where: type[WhereNode] = ...) -> None: ...
    @property
    ...
    def get_compiler(self, using: str | None = ..., connection: Any = ...) -> SQLCompiler: ...
    def clone(self) -> Query: ...
    def chain(self, klass: type[Query] | None = ...) -> Query: ...
    def relabeled_clone(self, change_map: dict[Any, Any] | OrderedDict[Any, Any]) -> Query: ...
    ...
    def change_aliases(self, change_map: dict[Any, Any] | OrderedDict[Any, Any]) -> None: ...
    ...
    def trim_joins(self, targets: tuple[Field[Any, Any]], joins: list[str], path: list[PathInfo]) -> tuple[tuple[Field[Any, Any]], str, list[str]]: ...
    def resolve_ref(self, name: str, allow_joins: bool = ..., reuse: set[str] | None = ..., summarize: bool = ...) -> Expression: ...
    def split_exclude(
        self,
    ...
    def add_fields(self, field_names: Iterator[Any] | list[str], allow_m2m: bool = ...) -> None: ...
    ...
    def get_loaded_field_names_cb(self, target: dict[type[Model], set[str]], model: type[Model], fields: set[Field[Any, Any]]) -> None: ...
    def set_annotation_mask(self, names: list[str] | set[str] | tuple[Any, ...] | None) -> None: ...
    ...
    def build_lookup(self, lookups: Sequence[str], lhs: RegisterLookupMixin | Query, rhs: Query | None) -> Lookup[Any]: ...
    def try_transform(self, lhs: RegisterLookupMixin | Query, name: str) -> Transform: ...
...
class JoinPromoter:
    ...
    def add_votes(self, votes: Iterator[Any] | list[Any] | set[str] | tuple[Any, ...]) -> None: ...
