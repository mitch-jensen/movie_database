...
class Lookup(Generic[_T]):
    ...
    def __init__(self, lhs: Expression | TextField[Any] | related_lookups.MultiColSource, rhs: Any) -> None: ...
    def apply_bilateral_transforms(self, value: Expression) -> Transform: ...
    def batch_process_rhs(self, compiler: SQLCompiler, connection: DatabaseWrapper, rhs: OrderedSet[Any] | None = ...) -> tuple[list[str], list[str]]: ...
    ...
    def process_lhs(self, compiler: SQLCompiler, connection: DatabaseWrapper, lhs: Expression | None = ...) -> tuple[str, list[int | str]]: ...
