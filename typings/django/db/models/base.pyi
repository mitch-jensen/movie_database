...
class Model(metaclass=ModelBase):
    ...
    def unique_error_message(self, model_class: type[Self], unique_check: Collection[Callable[..., Any] | str]) -> ValidationError: ...
    def save(self, force_insert: bool = ..., force_update: bool = ..., using: str | None = ..., update_fields: Iterable[str] | None = ...) -> None: ...
    async def asave(self, force_insert: bool = ..., force_update: bool = ..., using: str | None = ..., update_fields: Iterable[str] | None = ...) -> None: ...
    def save_base(
        self,
        raw: bool = ...,
        force_insert: bool = ...,
    ...
    def refresh_from_db(self, using: str | None = ..., fields: list[str] | None = ..., from_queryset: QuerySet[Self] | None = ...) -> None: ...
    async def arefresh_from_db(self, using: str | None = ..., fields: list[str] | None = ..., from_queryset: QuerySet[Self] | None = ...) -> None: ...
