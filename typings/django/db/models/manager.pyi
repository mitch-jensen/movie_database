...
class BaseManager(QuerySet[_T]):
    ...
    def deconstruct(self) -> tuple[bool, str | None, str | None, tuple[Any, ...] | None, dict[str, Any] | None]: ...
...
class RelatedManager(Manager[_T]):
    ...
    def set(self, objs: QuerySet[_T] | Iterable[_T], *, bulk: bool = ..., clear: bool = ...) -> None: ...
    async def aset(self, objs: QuerySet[_T] | Iterable[_T], *, bulk: bool = ..., clear: bool = ...) -> None: ...
    def clear(self) -> None: ...
...
class ManyToManyRelatedManager(Generic[_T, _V], Manager[_T]):
    ...
    def add(self, *objs: QuerySet[_T] | _T | _V, through_defaults: MutableMapping[str, Any] = ...) -> None: ...
    async def aadd(self, *objs: QuerySet[_T] | _T | _V, through_defaults: MutableMapping[str, Any] = ...) -> None: ...
    def remove(self, *objs: QuerySet[_T] | _T | _V) -> None: ...
    async def aremove(self, *objs: QuerySet[_T] | _T | _V) -> None: ...
    def set(self, objs: QuerySet[_T] | Iterable[_T], *, clear: bool = ..., through_defaults: MutableMapping[str, Any] = ...) -> None: ...
    async def aset(self, objs: QuerySet[_T] | Iterable[_T], *, clear: bool = ..., through_defaults: MutableMapping[str, Any] = ...) -> None: ...
    def clear(self) -> None: ...
    async def aclear(self) -> None: ...
    def create(self, defaults: MutableMapping[str, Any] | None = ..., through_defaults: MutableMapping[str, Any] | None = ..., **kwargs: Any) -> _T: ...
    async def acreate(self, defaults: MutableMapping[str, Any] | None = ..., through_defaults: MutableMapping[str, Any] | None = ..., **kwargs: Any) -> _T: ...
    def get_or_create(
        self,
