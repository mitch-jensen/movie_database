...
class CompositeAttribute:
    ...
    def __get__(self, instance: Model, cls: type[Model] | None = ...) -> tuple[Any, ...]: ...
...
class CompositePrimaryKey(Field[tuple[Any, ...] | None, tuple[Any, ...] | None]):
    ...
    def __init__(
        ...
        *args: str,
        ...
        choices: _LiteralFieldChoices | None = ...,
    ...
    @cached_property
    def fields(self) -> tuple[Field[Any, Any] | ForeignObjectRel | GenericForeignKey, ...]: ...
    @cached_property
    def columns(self) -> tuple[str, ...]: ...
    def __iter__(self) -> Iterator[Field[Any, Any] | ForeignObjectRel | GenericForeignKey]: ...
    def __len__(self) -> int: ...
    def get_pk_value_on_save(self, instance: Model) -> tuple[Any, ...] | None: ...
