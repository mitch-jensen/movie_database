...
type _ChoicesMapping = Mapping[Any, str | Mapping[Any, str]]
type _LiteralFieldChoices = Iterable[_Choice | _ChoiceNamedGroup] | _ChoicesMapping
type _FieldChoices = _LiteralFieldChoices | Callable[[], _LiteralFieldChoices]
...
class AutoField(AutoFieldMixin, IntegerField[int], metaclass=AutoFieldMeta):
    def __new__(
        ...
        unique_for_month: str | None = ...,
        unique_for_year: str | None = ...,
        choices: Iterable[tuple[int, str] | tuple[str, Iterable[tuple[int, str]]]] = ...,
        help_text: str = ...,
        db_column: str | None = ...,
        db_comment: str | None = ...,
        db_tablespace: str | None = ...,
...
class GenericIPAddressField(Generic[_C], Field[_C | ipaddress.IPv4Address | ipaddress.IPv6Address | Combinable, _C]):
    @overload
    def __new__(
        cls,
        verbose_name: str | None = ...,
