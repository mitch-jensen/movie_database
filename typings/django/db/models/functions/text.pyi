...
class LPad(BytesToCharFieldConversionMixin, Func):
    def __init__(self, expression: str, length: Length | int | None, fill_text: Value = ..., **extra: Any) -> None: ...

class LTrim(Transform): ...
class Ord(Transform): ...

class Repeat(BytesToCharFieldConversionMixin, Func):
    def __init__(self, expression: Value | str, number: Length | int | None, **extra: Any) -> None: ...
...
class Substr(Func):
    def __init__(self, expression: Expression | str, pos: Expression | int, length: Value | int | None = ..., **extra: Any) -> None: ...
