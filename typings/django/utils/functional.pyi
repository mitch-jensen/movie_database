...
def lazy(func: Callable[..., Any] | type[str], *resultclasses: Any) -> Callable[..., Any]: ...
...
def partition(predicate: Callable[..., Any], values: list[_PartitionMember]) -> tuple[list[_PartitionMember], list[_PartitionMember]]: ...
