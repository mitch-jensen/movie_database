...
class BaseConnectionHandler:
    ...
    def __init__(self, settings: dict[str, dict[str, Any]] | None = ...) -> None: ...
    @cached_property
    def settings(self) -> dict[str, dict[str, Any]]: ...
    def configure_settings(self, settings: dict[str, dict[str, Any]] | None) -> dict[str, dict[str, Any]]: ...
    @abstractmethod
    ...
    def all(self, initialized_only: bool = ...) -> list[BaseDatabaseWrapper]: ...
