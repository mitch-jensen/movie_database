...
class SimpleTestCase(unittest.TestCase):
    ...
    def assertNotContains(self, response: HttpResponse, text: bytes | str, status_code: int = ..., msg_prefix: str = ..., html: bool = ...) -> None: ...
    def assertFormError(self, response: HttpResponse, form: str, field: str | None, errors: list[str] | str, msg_prefix: str = ...) -> None: ...
    ...
    def assertInHTML(self, needle: str, haystack: SafeText, count: int | None = ..., msg_prefix: str = ...) -> None: ...
    def assertJSONEqual(
        self,
