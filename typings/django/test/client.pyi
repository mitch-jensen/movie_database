...
class RequestFactory:
    ...
    errors: BytesIO
    def __init__(self, *, json_encoder: type[JSONEncoder] = ..., headers: Mapping[str, Any] | None = ..., **defaults: Any) -> None: ...
    ...
    def trace(self, path: str, secure: bool = ..., *, QUERY_STRING: str = ..., headers: Mapping[str, Any] | None = ..., **extra: object) -> WSGIRequest: ...
    def options(
        self,
        path: str,
        data: _RequestData = ...,
