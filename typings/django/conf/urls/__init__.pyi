...
type IncludedURLConf = tuple[list[URLResolver], str | None, str | None]

def include(arg: Any, namespace: str = ..., app_name: str = ...) -> IncludedURLConf: ...
@overload
def url(regex: str, view: Callable[..., HttpResponseBase], kwargs: dict[str, Any] = ..., name: str = ...) -> URLPattern: ...
@overload
def url(regex: str, view: IncludedURLConf, kwargs: dict[str, Any] = ..., name: str = ...) -> URLResolver: ...
@overload
def url(regex: str, view: list[URLResolver | str], kwargs: dict[str, Any] = ..., name: str = ...) -> URLResolver: ...
