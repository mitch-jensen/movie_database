...
This type stub file was generated by pyright.
"""
type _AnyUser = Model | AnonymousUser
UserModel: Any

class BaseBackend:
    def authenticate(self, request: HttpRequest, username: str | None = ..., password: str | None = ..., **kwargs: Any) -> AbstractBaseUser | None: ...
    async def aauthenticate(self, request: HttpRequest, username: str | None = ..., password: str | None = ..., **kwargs: Any) -> AbstractBaseUser | None: ...
...
class ModelBackend(BaseBackend):
    ...
    def with_perm(self, perm: str | Permission, is_active: bool = ..., include_superusers: bool = ..., obj: Model | None = ...) -> Any: ...
