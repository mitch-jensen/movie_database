...
class GenericForeignKey(FieldCacheMixin):
    ...
    def get_content_type(self, obj: Model | None = ..., id: int | None = ..., using: str | None = ...) -> ContentType: ...
...
class GenericRelation(ForeignObject[Any]):
    ...
    def resolve_related_fields(self) -> list[tuple[PositiveIntegerField[Any], Field[Any, Any]]]: ...
    ...
    def get_extra_restriction(self, where_class: type[WhereNode], alias: str | None, remote_alias: str) -> WhereNode: ...
