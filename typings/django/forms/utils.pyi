...
class RenderableMixin:
    ...
    def render(self, template_name: str | None = ..., context: Mapping[str, Any] | None = ..., renderer: BaseRenderer | None = ...) -> SafeText: ...
...
class ErrorDict(dict[str, ErrorList], RenderableErrorMixin):
    ...
    def __init__(self, *args: Any, renderer: BaseRenderer | None = ..., **kwargs: Any) -> None: ...
...
class ErrorList(UserList[ValidationError | str], RenderableErrorMixin):
    ...
    error_class: str
    renderer: BaseRenderer
    def __init__(self, initlist: Sequence[str | Exception] | None = ..., error_class: str | None = ..., renderer: BaseRenderer | None = ...) -> None: ...
