...
class BoundField:
    ...
    def __getitem__(self, idx: int | slice | str) -> list[BoundWidget] | BoundWidget: ...
    @property
    def errors(self) -> ErrorList: ...
    def as_widget(self, widget: Widget | None = ..., attrs: None = ..., only_initial: bool = ...) -> SafeText: ...
    ...
    def data(self) -> Any: ...
    def value(self) -> Any: ...
    def label_tag(self, contents: str | None = ..., attrs: dict[str, str] | None = ..., label_suffix: str | None = ...) -> SafeText: ...
    ...
    def build_widget_attrs(self, attrs: dict[str, str], widget: Widget | None = ...) -> dict[str, bool | str]: ...
