...
This type stub file was generated by pyright.
"""
type _OptAttrs = dict[str, Any]

class MediaOrderConflictWarning(RuntimeWarning): ...

class Media:
    _js: str
    def __init__(self, media: type | None = ..., css: dict[str, Iterable[str]] | None = ..., js: Iterable[str] | None = ...) -> None: ...
    def render(self) -> str: ...
...
class Widget:
    ...
    def subwidgets(self, name: str, value: list[str] | None, attrs: _OptAttrs = ...) -> Iterator[dict[str, Any]]: ...
    def format_value(self, value: Any) -> str | None: ...
    def get_context(self, name: str, value: Any, attrs: _OptAttrs | None) -> dict[str, Any]: ...
    def render(self, name: str, value: Any, attrs: _OptAttrs | None = ..., renderer: BaseRenderer | None = ...) -> SafeText: ...
    def build_attrs(self, base_attrs: _OptAttrs, extra_attrs: _OptAttrs | None = ...) -> dict[str, Decimal | float | str]: ...
...
class CheckboxInput(Input):
    ...
    def __init__(self, attrs: _OptAttrs | None = ..., check_test: Callable[..., Any] | None = ...) -> None: ...
...
class ChoiceWidget(Widget):
    ...
    def __init__(self, attrs: _OptAttrs | None = ..., choices: Sequence[tuple[Any, Any]] = ...) -> None: ...
    def options(self, name: str, value: list[str], attrs: _OptAttrs | None = ...) -> None: ...
    def optgroups(self, name: str, value: list[str], attrs: _OptAttrs | None = ...) -> Any: ...
    def create_option(
        self,
        name: str,
        value: Any,
...
class MultiWidget(Widget):
    template_name: str = ...
    widgets: list[Widget] = ...
    def __init__(self, widgets: Sequence[Widget | type[Widget]], attrs: _OptAttrs | None = ...) -> None: ...
