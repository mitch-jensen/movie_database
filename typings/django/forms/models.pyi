...
"""
ALL_FIELDS: str
type _Fields = list[Callable[..., Any] | str] | Sequence[str] | Literal["__all__"]
type _Labels = dict[str, str]
type _ErrorMessages = dict[str, dict[str, str]]
_M = TypeVar("_M", bound=Model)

class FormFieldCallback(Protocol):
    def __call__(self, db_field: models.Field[Any, Any], **kwargs: Any) -> Field: ...

def construct_instance(form: BaseForm, instance: _M, fields: Container[str] | None = ..., exclude: Container[str] | None = ...) -> _M: ...
...
class InlineForeignKeyField(Field):
    ...
    pk_field: bool = ...
    to_field: str | None = ...
    def __init__(self, parent_instance: Model, *args: Any, pk_field: bool = ..., to_field: Any | None = ..., **kwargs: Any) -> None: ...
...
class ModelChoiceField(ChoiceField):
    ...
    def get_limit_choices_to(self) -> dict[str, datetime] | Q | MagicMock | None: ...
